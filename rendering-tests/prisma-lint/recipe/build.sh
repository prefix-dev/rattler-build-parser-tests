...
mkdir -p ${PREFIX}/bin
tee ${PREFIX}/bin/prisma-lint << EOF
#!/bin/sh
exec \${CONDA_PREFIX}/lib/node_modules/prisma-lint/dist/cli.js "\$@"
EOF
chmod +x ${PREFIX}/bin/prisma-lint

tee ${PREFIX}/bin/prisma-lint.cmd << EOF
call %CONDA_PREFIX%\bin\node %CONDA_PREFIX%\lib\node_modules\prisma-lint\dist\cli.js %*
EOF
