...
$CXX example.cc -o example $CXXFLAGS $LDFLAGS -lCentauro -lfastjettools -lfastjet
...
$CXX example.cc -o example $CXXFLAGS $LDFLAGS -lClusteringVetoPlugin -lfastjettools -lfastjet
